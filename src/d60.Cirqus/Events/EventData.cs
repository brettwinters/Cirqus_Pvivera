...
public class EventData
{
	...
	{
		return $"Event({(Meta.ContainsKey(DomainEvent.MetadataKeys.GlobalSequenceNumber) ? Meta[DomainEvent.MetadataKeys.GlobalSequenceNumber] : "?")})";
	}
